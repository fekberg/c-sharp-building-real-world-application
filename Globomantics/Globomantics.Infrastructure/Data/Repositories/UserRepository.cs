...
public class UserRepository : IRepository<User>
{
    ...
    public async Task AddAsync(User user)
    {
        ...
        {
            var userToAdd = DomainToDataMapping.MapFromDomainUser(user);
    ...
    public async Task<IEnumerable<User>> AllAsync()
    {
        return await context.Users
            .Select(x => DataToDomainMapping.MapDomainUserFromData(x))
            .ToArrayAsync();
    }
    ...
    public async Task<User> FindByAsync(string name)
    {
        ...
        return DataToDomainMapping.MapDomainUserFromData(user);
    }
